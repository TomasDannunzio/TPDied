...
public class FrameOpcionesSucursal extends JFrame {
	...
	public FrameOpcionesSucursal() {
		...
		gbl_contentPane.columnWidths = new int[]{100, 1, 100, 0};
		gbl_contentPane.rowHeights = new int[]{50, 1, 1, 50, 0};
		...
		gbl_Sucursalpanel.columnWidths = new int[]{50, 0, 25, 0, 50, 0};
		gbl_Sucursalpanel.rowHeights = new int[]{50, 0, 25, 0, 50, 0};
		gbl_Sucursalpanel.columnWeights = new double[]{0.0, 1.0, 0.0, 1.0, 0.0, Double.MIN_VALUE};
		gbl_Sucursalpanel.rowWeights = new double[]{0.0, 1.0, 0.0, 1.0, 0.0, Double.MIN_VALUE};
